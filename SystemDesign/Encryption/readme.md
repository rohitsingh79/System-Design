...
- Key exhanges is done using asymmetric encryption (using both the public and the private key) and message encryption and decryption are don using aes (symmetric encryption nd decryption 256 bits )
